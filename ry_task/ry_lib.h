...
#if RY_MEM == 1
extern void *ry_malloc(ry_cpu_t size);
extern void  ry_free(void *mem);
#endif

#if RY_MEMPOOL == 1
extern void          ry_mempool_reg(ry_mempool_t *mem, void *start, ry_cpu_t size, ry_cpu_t block_size);
extern ry_mempool_t *ry_mempool_create(ry_cpu_t block_num, ry_cpu_t block_size);
...
extern ry_cpu_t ry_interrupt_off(void);
extern void ry_interrupt_on(ry_cpu_t cmd);

#define  RY_NEW_IT_VARI       ry_cpu_t cmd
